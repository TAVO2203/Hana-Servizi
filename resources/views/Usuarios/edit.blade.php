...
<div class="form-container">
  ...
  <form action="{{route('Usuarios.update', $usuario->id)}}" method="POST">
    ...
    <input type="text" id="Nombre" name="Nombre" placeholder="Ingresa tu nombre" required value="{{$usuario->Nombre}}">

    <label for="Email">E-mail</label>
    <input type="email" id="Email" name="Email" placeholder="Ingresa tu correo" required value="{{$usuario->Email}}">

    <label for="Direccion">Dirección</label>
    <input type="text" id="Direccion" name="Direccion" placeholder="Ingresa tu dirección" required value="{{$usuario->Direccion}}">

    <label for="Telefono">Teléfono</label>
    <input type="tel" id="Telefono" name="Telefono" placeholder="Ingresa tu número de teléfono" required value="{{$usuario->Telefono}}">

    <div class="text-center">
        <input type="submit" class="btn_btn-primary" value="Guardar">
        <input type="reset" class="btn_btn-danger" value="Cancelar">
